...
namespace AirlineApp {
	...
	void Flight::setSeatNumber(int index) {
		string seat = mSeats[index];
	}

	string& Flight::getSeatNumber(int index) {
		return mSeats[index];
	}


	std::vector<std::string> mSeats{	
		"1A", "1B", "1C", "1D",
		"2A", "2B", "2C", "2D",
		"3A", "3B", "3C", "3D",
		"4A", "4B", "4C", "4D",
	...
	//std::map<std::string, vector<Passenger>> mSeats{
	//	{"1A", {}}, {"1B", {}}, {"1C", {}}, {"1D", {}},
	//	{"2A", {}}, {"2B", {}}, {"2C", {}}, {"2D", {}},
	//	{"3A", {}}, {"3B", {}}, {"3C", {}}, {"3D", {}},
	//	{"4A", {}}, {"4B", {}}, {"4C", {}}, {"4D", {}},
